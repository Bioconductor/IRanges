test_RleViews <- function() {
    ...
    checkEquals(sapply(xList, min), viewMins(xRleViews))
    checkEquals(sapply(xList, min, na.rm = TRUE), viewMins(xRleViews, na.rm = TRUE))
    checkEquals(sapply(xList, max), viewMaxs(xRleViews))
    checkEquals(sapply(xList, max, na.rm = TRUE), viewMaxs(xRleViews, na.rm = TRUE))
