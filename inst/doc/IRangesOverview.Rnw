...
as \Rclass{SimpleIntegerList} and \Rclass{SimpleRleList}, which inherit
from the \Rclass{Sequence} virtual class, for storing \Rclass{integer}
vectors and \Rclass{Rle} objects respectively.
